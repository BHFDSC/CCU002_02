...
if (data_version == "210607"){
  master_df_fpath <- "/mnt/efs/hyi20//CCU002_vac/data/ccu002_vacc_cohort_backup/ccu002_vacc_cohort_210607.csv.gz" # cached version
} else if (data_version == "death28days"){ #210610
  master_df_fpath <- "/mnt/efs/hyi20//CCU002_vac/data/ccu002_vacc_cohort.csv.gz"
  ls_events <-  ls_events[!ls_events %in% c("death")]
} else if (data_version == "anydiag"){
  master_df_fpath <- "/mnt/efs/hyi20//CCU002_vac/data/ccu002_vacc_cohort_altoutcomes_210616.csv.gz"
  ls_events <-  ls_events[!ls_events %in% c("death")]
}
