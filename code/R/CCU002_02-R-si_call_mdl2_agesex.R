## =============================================================================
## MODEL2: ADJUSTED for AGE & SEX (SUPPLEMENTARY TABLES 1 a & b)
## (1) Prep outcome and analysis specific dataset
##
## Author: Samantha Ip
## Contact detail: hyi20@medschl.cam.ac.uk
## =============================================================================
source("/mnt/efs/hyi20/dars_nic_391419_j3w9t_collab/CCU002_vac/scripts/CCU002_02-R-si_fit_model_agesex.R")
