...
fit_get_data_surv <- function(covars, vac_str, agebreaks, agelabels, agegp, event, survival_data, cuts_weeks_since_expo, cohort_start_date="2020-12-08", cohort_end_date="2021-03-18", expo="VACCINE", noncase_frac=0.1){
  ...
  with_expo %>% 
    dplyr::select(NHS_NUMBER_DEID, expo_date, end_date, event_date, days_to_end, DATE_OF_DEATH, DATE_VAC_CENSOR) %>%  
