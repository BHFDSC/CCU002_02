## =============================================================================
## MODEL3C: FULLY ADJUSTED -- USING PRE-DEFINED OUTSOME-SPECIFIC FIXED COVARIATES ONLY 
## NO BACKWARD-SELECTED COVARIATES (SUPPLEMENTARY TABLES 1 a & b)
...
source("/mnt/efs/hyi20//CCU002_vac/scripts/CCU002_02-R-si_fit_model_onlyfixedcovariates.R")
...
get_vacc_res <- function(event, vac_str, agegp, cohort_vac, agebreaks, agelabels, covars, cuts_weeks_since_expo, master_df_fpath, cohort_start_date, cohort_end_date, noncase_frac=0.1){
  ...
  res_vacc <- fit_model_fixedcovariates(covars, vac_str, agebreaks, agelabels, agegp, event, survival_data, cuts_weeks_since_expo, cohort_start_date="2020-12-08", cohort_end_date="2021-03-18", expo="VACCINE", noncase_frac=0.1)
