...
source("/mnt/efs/hyi20//CCU002_vac/scripts/si_02_pipe.R")
...
if (mdl == "mdl1_unadj"){
  ...
  source("/mnt/efs/hyi20//CCU002_vac/scripts/si_call_mdl1_unadj.R")
  ...
  source("/mnt/efs/hyi20//CCU002_vac/scripts/si_call_mdl2_agesex.R")
  ...
  source("/mnt/efs/hyi20//CCU002_vac/scripts/si_call_mdl3a_bkwdselect.R")
} else if (mdl == "mdl3b_fullyadj"){
  setwd(paste0("/mnt/efs/hyi20/dvt_icvt_results/", res_dir_date, "/fully_adj_bkwdselect/"))
  res_dir <- paste0("/mnt/efs/hyi20/dvt_icvt_results/", res_dir_date, "/fully_adj_bkwdselect/")
  source("/mnt/efs/hyi20//CCU002_vac/scripts/si_call_mdl3b_fullyadj.R")
  ...
  source("/mnt/efs/hyi20//CCU002_vac/scripts/si_call_mdl4_fullinteract_interactionterm.R")
