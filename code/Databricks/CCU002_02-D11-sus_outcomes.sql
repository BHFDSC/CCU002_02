...
-- MAGIC sus_data = '.ccu002_vac_sus_'
-- MAGIC 
...
-- MAGIC %sql
-- MAGIC CREATE TABLE .ccu002_vac_sus_diag_stack_vacc AS
-- MAGIC WITH CTE AS (
...
-- MAGIC select * from .ccu002_vac_sus_diag_stack_vacc
...
-- MAGIC %python
-- MAGIC create_table(table_name=final_table_1, database_name='', select_sql_script=f"SELECT * FROM global_temp.ccu002_vaccine_susoutcomes_final")
-- MAGIC 
...
-- MAGIC %python
-- MAGIC create_table(table_name=final_table_2, database_name='', select_sql_script=f"SELECT * FROM global_temp.ccu002_vaccine_susoutcomes_final_anydiag")
