...
-- MAGIC hes_data = '.ccu002_vac_hes_apc_all_years'
-- MAGIC 
...
-- MAGIC %python
-- MAGIC 
-- MAGIC create_table(table_name=final_table, database_name='', select_sql_script=f"SELECT * FROM global_temp.ccu002_vaccine_hesoutcomes_final")
-- MAGIC 
