...
-- MAGIC sus_table = '.ccu002_vac_outcomes_sus_final' #TWO FOR SUS TABLES 
-- MAGIC sus_table2 = '.ccu002_vac_outcomes_sus_final_anydiag'
...
CREATE TABLE .ccu002_vac_thrombo_outcomes_longformat_individual_events AS
WITH CTE AS (
...
from .ccu002_vac_thrombo_outcomes_longformat_individual_events

-- COMMAND ----------

select count(distinct NHS_NUMBER_DEID) as count, composite_event_type from .ccu002_vac_thrombo_outcomes_longformat_individual_events group by composite_event_type
