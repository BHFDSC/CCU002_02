...
-- MAGIC gdppr_data = '.ccu002_vac_gdppr_'
-- MAGIC 
...
-- MAGIC %py
-- MAGIC 
-- MAGIC create_table(table_name=final_table, database_name='', select_sql_script=f"SELECT * FROM global_temp.ccu002_vaccine_outcomes_gdppr_final")
-- MAGIC 
