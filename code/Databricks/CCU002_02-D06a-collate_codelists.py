...
# MAGIC        "" AS code_type,
# MAGIC        "" AS RecordDate
# MAGIC FROM .ccu002_vacc_drug_codelists
# MAGIC UNION ALL
# MAGIC SELECT *     
# MAGIC FROM .master_codelist_ccu002_vaccine_covariates_sjk
# MAGIC UNION ALL
...
# MAGIC        "" AS code_type,
# MAGIC        "" AS RecordDate       
# MAGIC FROM .ccu002_vaccine_smokingstatus_SNOMED
# MAGIC UNION ALL
# MAGIC SELECT *
...
# MAGIC        "" AS code_type,
# MAGIC        "" AS RecordDate
# MAGIC FROM .samantha_wp25_covariates_20210127_liver_ctv3_to_snomed_codelist
# MAGIC UNION ALL
# MAGIC SELECT name,
...
# MAGIC %sql
# MAGIC SELECT * FROM .ccu002_02_codelists
