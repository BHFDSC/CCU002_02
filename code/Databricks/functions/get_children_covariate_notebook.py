...
spark.sql("create table .ccu002_vac_disorder_lookup_full as select * from disorder_lookup")
spark.sql("ALTER TABLE .ccu002_vac_disorder_lookup_full OWNER TO ")
...
#df.createOrReplaceTempView("disorder_lookup") #so now global_temp.disorder_lookup for use in other notebook
#spark.sql("create table .ccu002_disorder_lookup as select * from disorder_lookup")
