...
# MAGIC REFRESH TABLE .ccu002_vac_hes_apc_all_years

# COMMAND ----------

# MAGIC %sql
# MAGIC -- Remove cached deaths table
# MAGIC REFRESH TABLE .ccu002_vac_deaths_

# COMMAND ----------

# MAGIC %sql
# MAGIC -- Remove cached skinny table
# MAGIC REFRESH TABLE .curr302_patient_skinny_record
...
# MAGIC                 DATE_OF_BIRTH,
# MAGIC                 DATE_OF_DEATH
# MAGIC FROM .curr302_patient_skinny_record
...
# MAGIC FROM .ccu002_vac_hes_apc_all_years
