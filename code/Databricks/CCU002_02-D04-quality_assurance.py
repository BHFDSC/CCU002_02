...
# MAGIC death_data = '.ccu002_deaths_'
# MAGIC 
# MAGIC 
...
preg = spark.table(".ccu002_vac_pregnancy_birth_sno")
...
pros = spark.table(".ccu002_vac_prostate_cancer_sno")
pros = [item.conceptid for item in pros.select('conceptid').collect()]

# COMMAND ----------

df_gdppr = spark.table(".ccu002_vac_df_gdppr_sex") # created for rule 6, no need to re-do
