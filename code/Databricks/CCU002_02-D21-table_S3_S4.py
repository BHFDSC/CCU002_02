...
# MAGIC %md # CCU002_02-D21-table_S3_S4
# MAGIC 
# MAGIC **Description** This notebook calculates event numbers for supplementary tables 3 and 4.
# MAGIC 
...
# MAGIC %sql
# MAGIC CREATE OR REPLACE GLOBAL TEMP VIEW ccu002_vacc_st_3_4 AS
# MAGIC SELECT *
# MAGIC FROM global_temp.st3_4_venous_astrazeneca
# MAGIC UNION ALL
# MAGIC SELECT *
# MAGIC FROM global_temp.st3_4_venous_pfizer
# MAGIC UNION ALL
# MAGIC SELECT *
# MAGIC FROM global_temp.st3_4_arterial_astrazeneca
# MAGIC UNION ALL
# MAGIC SELECT *
# MAGIC FROM global_temp.st3_4_arterial_pfizer
...
drop_table('ccu002_vacc_st_3_4')
create_table('ccu002_vacc_st_3_4')
...
# MAGIC %sql
# MAGIC SELECT * FROM dars_nic_391419_j3w9t_collab.ccu002_vacc_st_3_4
