...
-- MAGIC skinny_data = '.ccu002_vac_skinny_patient'
-- MAGIC death_data = '.ccu002_vac_deaths_'
-- MAGIC sgss_data = '.ccu002_vac_sgss_'
-- MAGIC 
-- MAGIC #Other data inputs
-- MAGIC conflicting_quality_assurance = '.ccu002_vac_conflictingpatients'
-- MAGIC 
...
---%md %run "/Workspaces//CCU002_vacc/Data_Curation/in_progress/CCU002-D03-quality_assurance_parameters_new"
...
LEFT JOIN .ccu002_vac_conflictingpatients t2 ---those who didnt meet QA criteria, from the previous notebook
