...
-- MAGIC deaths_data = '.ccu002_vac_deaths_'
-- MAGIC 
...
-- MAGIC %python
-- MAGIC 
-- MAGIC create_table(table_name=final_table, database_name='', select_sql_script=f"SELECT * FROM global_temp.ccu002_vaccine_deaths_outcomes_vacc5_final")
-- MAGIC 
